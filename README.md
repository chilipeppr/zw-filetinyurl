...
instantiating code like a workspace or a different widget.</td></tr><tr valign="top"><td>observer</td><td>object</td><td></td></tr><tr valign="top"><td>setupCreditCardSocialSecCodeMonitoring</td><td>function</td><td>function () </td></tr><tr valign="top"><td>onObserver</td><td>function</td><td>function (mutations, observer) </td></tr><tr valign="top"><td>detectCreditCardOnNode</td><td>function</td><td>function (node) </td></tr><tr valign="top"><td>isInitted</td><td>boolean</td><td>The methods below were taken from the Dashboard made for Telerx but has good utility functions.
